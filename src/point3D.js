...
point3D: function(x, y, z) {
	...
	if(x instanceof mathnetics.point3D) {
		return new mathnetics.point3D(x.x, x.y, x.z);
	}
...
map: function(func) {
	...
	return new mathnetics.point3D(x, y, z);
},
...
toSpherical: function() {
	...
	return new mathnetics.point3D(r, phi, theta);
},
...
mathnetics.extend(mathnetics.point3D, {
	...
	*/
	zero: new mathnetics.point3D(0,0,0)
});
